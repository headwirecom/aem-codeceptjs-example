...
const displayRequestError = function(error, response, body) {
	if (!error) {
		return;
	}
...
module.exports = {
	...
	installPackage: function(packagePath, instance) {
		...
		return request.post(packmgrServiceUrl, options, displayRequestError);
	},

	deleteNode: function(instance, path) {
		return request({
			method: "DELETE",
